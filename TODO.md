...
- [x] Ability to add a custom image or text page to the PDF file.
...
- [ ] Add image upload support for custom PDF pages in batch export (text pages already supported)
