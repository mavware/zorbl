...
class extends Component {
    ...
    public function togglePublished(): void
    {
        ...
        if ($this->isPublished) {
            $this->authorize('publish', $crossword);
        }
    ...
    >
        ...
        >
            ...
            <div class="max-h-[60vh] overflow-y-auto px-6 py-4">
                ...
                {{-- Grid Editing --}}
                <h3 class="mb-2 text-xs font-semibold tracking-wider text-zinc-500 uppercase">{{ __('Grid Editing') }}</h3>
                <div class="mb-4 space-y-1.5">
                    <x-solver-shortcut keys="Space" :description="__('Toggle black square')" />
