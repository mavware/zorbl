    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="rounded-xl border border-zinc-200 p-5 dark:border-zinc-700">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <flux:text size="sm" class="text-zinc-500">{{ __('Published') }}</flux:text>
        ...
        <div class="rounded-xl border border-zinc-200 p-5 dark:border-zinc-700">
            <div class="flex items-center gap-3">
                <div class="flex size-10 items-center justify-center rounded-lg bg-zinc-100 dark:bg-zinc-800">
                    <flux:icon name="pencil" class="size-5 text-zinc-600 dark:text-zinc-400" />
                </div>
                <div>
                    <flux:text size="sm" class="text-zinc-500">{{ __('Drafts') }}</flux:text>
    ...
    <div class="rounded-xl border border-zinc-200 p-5 dark:border-zinc-700">
        ...
        <div class="grid gap-4 sm:grid-cols-3">
            <div class="text-center">
                ...
                <flux:text size="sm" class="text-zinc-500">{{ __('Published Puzzles') }}</flux:text>
            </div>
            <div class="text-center">
