...
new class extends Component {
    ...
    public function limitMessage(): ?string
    {
        ...
        return __('You have reached your puzzle limit.');
    }
...
<div class="space-y-4 text-left">
    ...
    <div class="flex items-center gap-2 pt-2">
        <button
            ...
            class="btn-classical-primary flex mr-3 rounded-xl border border-amber-500 bg-transparent px-8 py-2.5 text-base font-semibold text-amber-400 transition hover:bg-amber-500/10 hover:text-amber-300 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-transparent disabled:hover:text-amber-400"
        >
            {{ __('Start building') }}
        </button>
        @if ($this->atPuzzleLimit)
