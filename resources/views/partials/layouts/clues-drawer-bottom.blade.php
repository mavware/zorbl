...
>
    ...
    <div
        ...
        x-cloak
        class="absolute inset-x-0 bottom-0 z-20 hidden h-64 flex-row gap-4 border-t border-zinc-300 bg-white p-4 shadow-xl lg:flex dark:border-zinc-700 dark:bg-zinc-900"
    >
        <div class="flex min-h-0 flex-1 flex-col overflow-hidden">
