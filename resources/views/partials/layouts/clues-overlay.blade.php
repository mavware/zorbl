...
>
    ...
    <div
        ...
        x-transition
        x-cloak
        class="bg-surface border-line absolute inset-x-4 bottom-20 top-4 z-20 hidden flex-col gap-4 rounded-lg border /95 p-4 shadow-xl backdrop-blur lg:flex lg:flex-row /95"
    >
