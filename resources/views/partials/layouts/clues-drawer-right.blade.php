{{-- CluesDrawerRight: slide-out clue drawer on the right of the grid; the
     suggestions pane sits on the left, clear of the drawer. --}}
<div
...
>
    ...
    <button
        ...
        class="absolute right-4 top-4 z-30 hidden rounded-md bg-zinc-800 px-3 py-1.5 text-sm font-medium text-white shadow hover:bg-zinc-700 dark:bg-zinc-200 dark:text-zinc-900 dark:hover:bg-white lg:inline-flex"
    >
    ...
    <div
        ...
        x-cloak
        class="bg-surface border-line absolute inset-y-0 right-0 z-20 hidden w-72 flex-col gap-4 border-l p-4 shadow-xl lg:flex"
    >
        <div class="flex min-h-0 flex-1 flex-col overflow-hidden">
