{{-- Persistent suggestions pane. A fixed-width column that always reflects the
     ...
     partials only; below `lg` the mobile clue list keeps its inline popovers.
                    ...
                    <div class="space-y-px">
                        <template x-for="(suggestion, idx) in wordSuggestions" :key="'pane-w-' + idx + '-' + suggestion.word">
                            <div
                                ...
                                class="flex cursor-pointer items-center justify-between gap-2 rounded px-2 py-1 text-sm"
                            >
