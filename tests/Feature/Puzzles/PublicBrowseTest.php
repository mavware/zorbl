...
/*
 * The public /puzzles page is a thin wrapper around the <livewire:puzzle-discovery>
 * component. Filtering, sorting, liking, solving, daily-pinning and card rendering
 * are exercised in tests/Feature/PuzzleDiscoveryTest.php. This file only covers
 * page-level concerns: that the route renders, and that the guest/authenticated
 * call-to-action differs.
 */
...
// --- Puzzle Type Label (model behaviour) ---
